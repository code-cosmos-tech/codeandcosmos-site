    ...
    <footer className="footer">
      ...
      <div className="footbar">
        ...
        <div className="socials">
            <Button link="https://www.instagram.com/code_cosmos_tech/" iclass="fa-brands fa-instagram"/>
            <Button link="https://www.instagram.com/code_cosmos_tech/" iclass="fa-brands fa-x-twitter"/>
        </div>
      </div>
